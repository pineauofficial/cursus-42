...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/09 16:41:13 by pineau            #+#    #+#             */
/*   Updated: 2023/04/10 14:15:35 by pineau           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (argc < 2)
	{
		write(2, "Utilisez Mandelbrot, Julia, BuningShip\n", 39);
		return (0);
	}
	...
	if (nums == 1 && argc == 2)
		...
		write(2, "Utilisez BurningShip uniquement\n", 32);
	else
		write(1, "Utilisez Mandelbrot, Julia, BuningShip\n", 39);
	return (0);
}
